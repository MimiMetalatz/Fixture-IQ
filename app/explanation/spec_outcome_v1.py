...
WORDING_NO_CLEAR_LEAN = (
    "Based on the pre-match context, the {fixture} fixture does not present a clear outcome lean. "
...
WORDING_LOW_LEAN = (
    "Based on the pre-match context, the {fixture} fixture shows a slight lean toward {side}. "
...
WORDING_MODERATE_LEAN = (
    "Based on the pre-match context, the {fixture} fixture shows a moderate confidence lean toward {side}. "
...
WORDING_HIGH_LEAN = (
    "Based on the pre-match context, the {fixture} fixture shows a high confidence lean toward {side}. "
